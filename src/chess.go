...
func setup() {
	...
	for y := 0; y<spaces; y++ {
		...
		for x := 0; x<spaces+1+y; x++ {
			if x>0 {
				...
				chess.Data["en"]["board"] = append(chess.Data["en"]["board"], fmt.Sprintf(
	...
	bQ := html.NewTag("g","","","fill:#000000; stroke:none;","").AppendChild(
		html.NewTag2("circle","",[]string{"cx:::6","cy:::12","t:::2.75",})).AppendChild(
		html.NewTag2("circle","",[]string{"cx:::14","cy:::9","t:::2.75",})).AppendChild(
		html.NewTag2("circle","",[]string{"cx:::22.5","cy:::8","t:::2.75",})).AppendChild(
		html.NewTag2("circle","",[]string{"cx:::31","cy:::9","t:::2.75",})).AppendChild(
		html.NewTag2("circle","",[]string{"cx:::39","cy:::12","t:::2.75",}))
	blackQueen := html.NewTag2("g","",[]string{fmt.Sprintf("transform:::translate(%d,%d) scale(1.1)",offX+313,offY-20), "id:::blackQueen", "style:::opacity:1; fill:000000; fill-opacity:1; fill-rule:evenodd; stroke:#000000; stroke-width:1.5; stroke-linecap:round;stroke-linejoin:round;stroke-miterlimit:4; stroke-dasharray:none; stroke-opacity:1;",})
	blackQueen.AppendChild(bQ).AppendChild(
		html.NewTag2("path","",[]string{"d:::M 9,26 C 17.5,24.5 30,24.5 36,26 L 38.5,13.5 L 31,25 L 30.7,10.9 L 25.5,24.5 L 22.5,10 L 19.5,24.5 L 14.3,10.9 L 14,25 L 6.5,13.5 L 9,26 z","style:::stroke-linecap:butt; stroke:#000000;",})).AppendChild(
		html.NewTag2("path","",[]string{"d:::M 9,26 C 9,28 10.5,28 11.5,30 C 12.5,31.5 12.5,31 12,33.5 C 10.5,34.5 10.5,36 10.5,36 C 9,37.5 11,38.5 11,38.5 C 17.5,39.5 27.5,39.5 34,38.5 C 34,38.5 35.5,37.5 34,36 C 34,36 34.5,34.5 33,33.5 C 32.5,31 32.5,31.5 33.5,30 C 34.5,28 36,28 36,26 C 27.5,24.5 17.5,24.5 9,26 z","style:::stroke-linecap:butt;",})).AppendChild(
		html.NewTag2("path","",[]string{"d:::M 11,38.5 A 35,35 1 0 0 34,38.5","style:::fill:none; stroke:#000000; stroke-linecap:butt;",})).AppendChild(
		html.NewTag2("path","",[]string{"d:::M 11,29 A 35,35 1 0 1 34,29","style:::fill:none; stroke:#ffffff;",})).AppendChild(
		html.NewTag2("path","",[]string{"d:::M 12.5,31.5 L 32.5,31.5","style:::fill:none; stroke:#ffffff;",})).AppendChild(
		html.NewTag2("path","",[]string{"d:::M 11.5,34.5 A 35,35 1 0 0 33.5,34.5","style:::fill:none; stroke:#ffffff;",})).AppendChild(
		html.NewTag2("path","",[]string{"d:::M 10.5,37.5 A 35,35 1 0 0 34.5,37.5","style:::fill:none; stroke:#ffffff;",}))
	chess.Html.Tag("blackQueen",blackQueen)
	
	chess.Html.Tag("blackCannon", html.NewTag2("g","", []string{fmt.Sprintf("transform:::translate(%d,%d) scale(1.1)",offX+265,offY-12), "id:::blackCannon", "stroke-linejoin:::round; fill:000000; fill-opacity:1;", "stroke:::#000 stroke-width:1.5; stroke-linecap:round;stroke-linejoin:round;stroke-miterlimit:4; stroke-dasharray:none; stroke-opacity:1;", }).AppendChild(
		html.NewTag2("g","",[]string{"stroke-width:::1.00000001", "stroke-linecap:::butt", "fill:::#000",}).AppendChild(
			html.NewTag2("path","",[]string{"d:::M13,20c-1.3,0.9-3.4,1.5-5,1.5-1.64,0-2.74,1-4,2.5,1,0,2.87-0.5,4.5-0.5,1.6,0,3.3,0,4.5-0.5,1.2,0.5,2.9,0.5,4.5,0.5s3.5,0.5,4.5,0.5c-1.3-1.5-2.4-2.5-4-2.5s-3.7-0.6-5-1.5z", "transform:::scale(1.7307692,1.7307692)",})).AppendChild(
			html.NewTag2("path","",[]string{"d:::M11,4c-2-2-8,4-6,6l5,5s-2,1.5-1,2.5c0,0-1,1,0,2,0.71,0.7,2,0.5,4,0.5s3.3,0.2,4-0.5c1-1,0-2,0-2,1-1-1-2.5-1-2.5,1.2467-0.35064,2.4102-3.5898,1-5z", "transform:::scale(1.7307692,1.7307692)",}))))
					
				
	for i:=0; i<2; i++ {
		chess.Html.Tag("blackCannon", html.NewTag2("g","", []string{
			fmt.Sprintf("id:::blackRook%d",i+1),
			fmt.Sprintf("transform:::translate(%d,%d)",offX+68+390*i,offY-12),
			"style:::opacity:1; fill:000000; fill-opacity:1; fill-rule:evenodd; stroke:#000000; stroke-width:1.5; stroke-linecap:round;stroke-linejoin:round;stroke-miterlimit:4; stroke-dasharray:none; stroke-opacity:1;",
				...
				html.NewTag2("path","",[]string{"d:::M 9,39 L 36,39 L 36,36 L 9,36 L 9,39 z", "style:::stroke-linecap:butt;",})).AppendChild(
				html.NewTag2("path","",[]string{"d:::M 12.5,32 L 14,29.5 L 31,29.5 L 32.5,32 L 12.5,32 z", "style:::stroke-linecap:butt;",})).AppendChild(
				html.NewTag2("path","",[]string{"d:::M 12,36 L 12,32 L 33,32 L 33,36 L 12,36 z", "style:::stroke-linecap:butt;",})).AppendChild(
				html.NewTag2("path","",[]string{"d:::M 14,29.5 L 14,16.5 L 31,16.5 L 31,29.5 L 14,29.5 z", "style:::stroke-linecap:butt;stroke-linejoin:miter;",})).AppendChild(
				html.NewTag2("path","",[]string{"d:::M 14,16.5 L 11,14 L 34,14 L 31,16.5 L 14,16.5 z", "style:::stroke-linecap:butt;",})).AppendChild(
				html.NewTag2("path","",[]string{"d:::M 11,14 L 11,9 L 15,9 L 15,11 L 20,11 L 20,9 L 25,9 L 25,11 L 30,11 L 30,9 L 34,9 L 34,14 L 11,14 z", "style:::stroke-linecap:butt;",})).AppendChild(
				html.NewTag2("path","",[]string{"d:::M 12,35.5 L 33,35.5 L 33,35.5", "style:::fill:none; stroke:#ffffff; stroke-width:1; stroke-linejoin:miter;",})).AppendChild(
				html.NewTag2("path","",[]string{"d:::M 13,31.5 L 32,31.5", "style:::fill:none; stroke:#ffffff; stroke-width:1; stroke-linejoin:miter;",})).AppendChild(
				html.NewTag2("path","",[]string{"d:::M 14,29.5 L 31,29.5", "style:::fill:none; stroke:#ffffff; stroke-width:1; stroke-linejoin:miter;",})).AppendChild(
				html.NewTag2("path","",[]string{"d:::M 14,16.5 L 31,16.5", "style:::fill:none; stroke:#ffffff; stroke-width:1; stroke-linejoin:miter;",})).AppendChild(
				html.NewTag2("path","",[]string{"d:::M 11,14 L 34,14", "style:::fill:none; stroke:#ffffff; stroke-width:1; stroke-linejoin:miter;",})))
				
		chess.Html.Tag(fmt.Sprintf("id:::blackKnight%d",i+1), html.NewTag2("g","", []string{
			fmt.Sprintf("id:::blackKnight%d",i+1),
			fmt.Sprintf("transform:::translate(%d,%d) scale(1)",offX+68+390*i,offY-12),
			"style:::opacity:1; fill:none; fill-opacity:1; fill-rule:evenodd; stroke:#000000; stroke-width:1.5; stroke-linecap:round;stroke-linejoin:round;stroke-miterlimit:4; stroke-dasharray:none; stroke-opacity:1;",
				...
				html.NewTag2("path","",[]string{"d:::M 22,10 C 32.5,11 38.5,18 38,39 L 15,39 C 15,30 25,32.5 23,18", "fill:#000000; stroke:#000000;",})).AppendChild(
				html.NewTag2("path","",[]string{"d:::M 24,18 C 24.38,20.91 18.45,25.37 16,27 C 13,29 13.18,31.34 11,31 C 9.958,30.06 12.41,27.96 11,28 C 10,28 11.19,29.23 10,30 C 9,30 5.997,31 6,26 C 6,24 12,14 12,14 C 12,14 13.89,12.1 14,10.5 C 13.27,9.506 13.5,8.5 13.5,7.5 C 14.5,6.5 16.5,10 16.5,10 L 18.5,10 C 18.5,10 19.28,8.008 21,7 C 22,7 22,10 22,10", "fill:#000000; stroke:#000000;",})).AppendChild(
				html.NewTag2("path","",[]string{"d:::9.5 25.5 A 0.5 0.5 0 1 1 8.5,25.5 A 0.5 0.5 0 1 1 9.5 25.5 z", "fill:#ffffff; stroke:#ffffff;",})).AppendChild(
				html.NewTag2("path","",[]string{"d:::M 15 15.5 A 0.5 1.5 0 1 1  14,15.5 A 0.5 1.5 0 1 1  15 15.5 z", "fill:#ffffff; stroke:#ffffff;", "transform:::matrix(0.866,0.5,-0.5,0.866,9.693,-5.173)",})).AppendChild(
				html.NewTag2("path","",[]string{"d:::M 15 15.5 A 0.5 1.5 0 1 1  14,15.5 A 0.5 1.5 0 1 1  15 15.5 z", "fill:#ffffff; stroke:#ffffff;", "transform:::matrix(0.866,0.5,-0.5,0.866,9.693,-5.173)",})).AppendChild(
				html.NewTag2("path","",[]string{"d:::M 24.55,10.4 L 24.1,11.85 L 24.6,12 C 27.75,13 30.25,14.49 32.5,18.75 C 34.75,23.01 35.75,29.06 35.25,39 L 35.2,39.5 L 37.45,39.5 L 37.5,39 C 38,28.94 36.62,22.15 34.25,17.66 C 31.88,13.17 28.46,11.02 25.06,10.5 L 24.55,10.4 z", "fill:#ffffff; stroke:#ffffff;",})))
				
		chess.Html.Tag(fmt.Sprintf("id:::blackBissop%d",i+1), html.NewTag2("g","", []string{
			fmt.Sprintf("id:::blackBissop%d",i+1),
			fmt.Sprintf("transform:::translate(%d,%d) scale(1)",offX+168+193*i,offY-10),
			...
			}).AppendChild( html.NewTag2("g","",[]string{"style:::fill:#000000; stroke:#000000; stroke-linecap:butt;",}).AppendChild(
				html.NewTag2("path","",[]string{"d:::M 9,36 C 12.39,35.03 19.11,36.43 22.5,34 C 25.89,36.43 32.61,35.03 36,36 C 36,36 37.65,36.54 39,38 C 38.32,38.97 37.35,38.99 36,38.5 C 32.61,37.53 25.89,38.96 22.5,37.5 C 19.11,38.96 12.39,37.53 9,38.5 C 7.646,38.99 6.677,38.97 6,38 C 7.354,36.06 9,36 9,36 z",})).AppendChild(
				html.NewTag2("path","",[]string{"d:::M 15,32 C 17.5,34.5 27.5,34.5 30,32 C 30.5,30.5 30,30 30,30 C 30,27.5 27.5,26 27.5,26 C 33,24.5 33.5,14.5 22.5,10.5 C 11.5,14.5 12,24.5 17.5,26 C 17.5,26 15,27.5 15,30 C 15,30 14.5,30.5 15,32 z",})).AppendChild(
				html.NewTag2("path","",[]string{"d:::M 25 8 A 2.5 2.5 0 1 1  20,8 A 2.5 2.5 0 1 1  25 8 z",}))))
